...
<Accordion title="Mám Vám předem popsat podrobněji můj problém do emailu?">
	...
	možnostech Váš email číst. Pro vzájemné poznávání (kam spadá také oblast problému, se kterým ke
	mně jdete) slouží první konzultace.
</Accordion>
...
<Accordion
	title="Poslala jsem platbu z přítelova účtu a zapomněla jsem uvést své příjmení do poznámky. Co mám dělat?"
>
